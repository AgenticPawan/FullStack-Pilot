...
| C | Wire sql-mcp into sql-support/sql-implementor; microsoft-learn into dotnet-support/dotnet-implementor; more azure-mcp tools into infra-reviewer/infra-implementor/azure-support; github MCP into git-workflow-governance; Playwright into angular-implementor | agent files |
...
- [ ] Phase A — rules-catalog completeness
- [ ] Phase B — dangling `/pilot-upgrade` references
- [ ] Phase C — MCP wiring
- [ ] Phase D — new skills (dotnet-security-headers, angular-ui-ux-consistency)
- [ ] Phase E — foundation-bootstrap skill + `/fsp-bootstrap` command + hard gate
