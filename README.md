...
|---|---|---|
| `pilot-core` | Implemented | 9 skills: stack detection, scaffold, audit/fix pipelines, MCP discovery, dependency-supply-chain policy (patch SLAs, SBOM), incident-response runbook/postmortem governance, open-source license compliance, `/pilot-init` `/pilot-audit` `/pilot-fix` `/pilot-learn` |
