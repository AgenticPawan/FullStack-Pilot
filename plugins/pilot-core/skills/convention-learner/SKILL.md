...
when_to_use: Run via /pilot-learn --conventions or when the user asks to detect conventions, learn naming patterns, document project structure, or update conventions.md. Also triggered after /pilot-init to capture patterns the profile does not cover.
...
_Generated by convention-learner on <ISO date>. Re-run `/pilot-learn --conventions` after major refactors._
